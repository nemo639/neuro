...
class LIMEExplainer:
    ...
    def _approx_lime_tabular(
        ...
        sensitivity = {
            ...
            "stroop_avg_rt": 0.4, "stroop_error_rate": 0.5,
            "stroop_congruent_rt": 0.3, "stroop_incongruent_rt": 0.4,
            "nback_hits": -0.5, "nback_false_alarms": 0.5,
            ...
            # CDT
            "shulman_score": -0.7, "number_accuracy": -0.6,
            ...
            "hnr": -0.4, "f0_mean": -0.3, "f0_std": -0.4,
            "mean_pause_duration": 0.4, "max_pause_duration": 0.3,
            "story_coherence": -0.5, "word_count": -0.3, "unique_words": -0.3,
            "zcr_mean": 0.2, "energy_std": 0.2,
            "spectral_centroid_mean": 0.2, "spectral_rolloff_mean": 0.2,
