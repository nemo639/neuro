...
Map<String, Map<String, dynamic>> _testResults = {};
  ...
  final List<TestComponent> testComponents = [
    TestComponent(
      name: 'Resting Tremor',
      description: 'Detect hand tremor using phone sensors',
      duration: '2 min',
      isCompleted: false,
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Text(
            'Your motor analysis is complete. You can view detailed AI explanations or return to tests.',
      ...
      actions: [
        ...
        ElevatedButton.icon(
          onPressed: () {
            Navigator.pop(ctx);
            Navigator.pushReplacementNamed(context, '/XAI', arguments: {'result': {...resultData, 'category': 'motor'}});
          },
