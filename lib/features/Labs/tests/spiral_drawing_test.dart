...
class _SpiralDrawingTestScreenState extends State<SpiralDrawingTestScreen>
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.gesture_rounded, color: orangeAccent, size: r.dp(40)),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildInstructionRow(Icons.gesture, 'Trace the spiral from center outward', r),
                SizedBox(height: r.h(10)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: _buildHandResultCard('Left Hand', leftTremor, leftAccuracy, blueAccent, r)),
              SizedBox(width: r.w(12)),
              Expanded(child: _buildHandResultCard('Right Hand', rightTremor, rightAccuracy, purpleAccent, r)),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.track_changes, size: r.dp(16), color: Colors.grey),
                    SizedBox(width: r.w(8)),
                    Text('Accuracy: How close to the template', style: TextStyle(fontSize: r.sp(12), color: Colors.grey[600])),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildHandResultCard(String title, String tremor, String accuracy, Color color, Responsive r) {
    return Container(
      padding: EdgeInsets.all(r.dp(14)),
      decoration: BoxDecoration(
        color: color.withOpacity(0.1),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                children: [
                  Text(accuracy, style: TextStyle(fontSize: r.sp(22), fontWeight: FontWeight.w800, color: color)),
                  Text('Accuracy', style: TextStyle(fontSize: r.sp(10), color: Colors.grey[600])),
                ],
              ),
            ],
          ),
